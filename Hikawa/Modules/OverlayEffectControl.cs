...
namespace Hikawa.Modules
{
	...
	public class OverlayEffectControl
    {
        ...
        private const float TextureScale = Game1.pixelZoom;
        ...
        public bool Set(Effect whichEffect, float effectScale)
        {
            ...
            switch (whichEffect)
            {
                ...
                case Effect.Nighttime:
                    _fxTexture = ModEntry.Instance.Helper.GameContent.Load<Texture2D>(AssetManager.ExtraSpritesAssetName);
                ...
                case Effect.StuffAbove:
                    ...
                    // _fxTexture = ModEntry.Instance.Helper.ModContent.Load<Texture2D>(Game1.currentLocation.Map.GetTileSheet(ModConsts.BusSpritesFile).ImageSource);
                    _isGluedToViewport = true;
        ...
        public void Enable(Effect whichEffect)
        {
            Enable(whichEffect, 1f);
        }

        public void Enable(Effect whichEffect, float effectScale)
        {
        ...
        {
            /*
            // TODO: TEST: Should this Effect.Nighttime check be == instead of != ?
            if (_currentEffect != Effect.Nighttime && Game1.timeOfDay >= Game1.getStartingToGetDarkTime())
            {
                _fxOpacity = Utils.GetProgressFromEveningIntoNighttime();
            }
            */
        }
        ...
        /// </summary>
        private void DrawMist(SpriteBatch b)
        {
                ...
                case Effect.Nighttime:
                    {
                        ...
                        var topleft = new Vector2(
                            Game1.graphics.GraphicsDevice.Viewport.TitleSafeArea.Center.X - gradientSize / 2 * TextureScale,
                            Game1.graphics.GraphicsDevice.Viewport.TitleSafeArea.Center.Y - gradientSize / 2 * TextureScale);
